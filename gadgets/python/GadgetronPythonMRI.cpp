...
BOOST_PYTHON_MODULE(GadgetronPythonMRI)
{
    ...
    class_<Gadgetron::GadgetReference>("GadgetReference")
      ...
      .def("return_acquisition_traj", &Gadgetron::GadgetReference::return_acquisition_traj)
      .def("return_recondata",&Gadgetron::GadgetReference::return_recondata)
      .def("return_recondataspiral",&Gadgetron::GadgetReference::return_recondataspiral)
    ...
    class_<Gadgetron::GadgetInstrumentationStreamControllerWrapper>("GadgetInstrumentationStreamController")
      ...
      .def("put_acquisition_traj", &Gadgetron::GadgetInstrumentationStreamControllerWrapper::put_acquisition_traj)
      .def("put_recondata", &Gadgetron::GadgetInstrumentationStreamControllerWrapper::put_recondata)
      .def("put_recondataspiral", &Gadgetron::GadgetInstrumentationStreamControllerWrapper::put_recondataspiral)
